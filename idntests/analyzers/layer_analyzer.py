from idntests.analyzers.FLOPs_analyzer import *
from idntests.analyzers.memory_analyzer import *
from idntests.analyzers.outputsize_analyzer import *
...
if __name__ == '__main__':
    ...
    sys.path.append("..")
    from idntests.models.resnet import resnet101
