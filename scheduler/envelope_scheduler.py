...
# 注册环境
register(
    id="SchedulingEnv-v0",  # 给环境分配唯一 ID
    entry_point="core.scheduler_env:SchedulingEnv",  # 模块路径
)
...
if __name__ == "__main__":
    def make_env():
        ...
        env = gymnasium.make("SchedulingEnv-v0", isn=isn, request=request)  # 使用注册的 ID 创建环境
